...
<section id="hero" class="hero section dark-background">
  ...
  <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-item active">
      <img src="{{ asset('frontend/estateagency/assets/img/hero-carousel/hero-carousel-1.jpg') }}" alt="">
    ...
    <div class="carousel-item">
      <img src="{{ asset('frontend/estateagency/assets/img/hero-carousel/hero-carousel-2.jpg') }}" alt="">
      <div class="carousel-container">
        <div>
          <p>Doral, Florida</p>
    ...
    <div class="carousel-item">
      <img src="{{ asset('frontend/estateagency/assets/img/hero-carousel/hero-carousel-3.jpg') }}" alt="">
      <div class="carousel-container">
        <div>
          <p>Doral, Florida</p>
